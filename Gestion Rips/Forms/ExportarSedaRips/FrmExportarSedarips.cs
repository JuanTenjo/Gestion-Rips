            ...
            try
            {
                ...
                else
                {
                    ...
                    while (TabLocal.Read())
                    {
                        ...
                        SqlDataReader TablaAux9 = Conexion.SQLDataReader(Utils.SqlDatos);
            ...
            try
            {
                ...
                else
                {
                    ...
                    if (sqlDataReader.HasRows)
                    {
                        ...
                        TUReg = sqlDataReader["RegimenAdmin"].ToString();
                        AcRe = sqlDataReader["ActiReali"].ToString();
                        CR = txtRips.Text;
                        Para01 = Coenti02;
                    }
                    sqlDataReader.Close();
        ...
        private void btnExportar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (Respuesta == DialogResult.Yes)
                {
                    ...
                    {
                        VR = 0;
                        SqlsuaTemp = "SELECT  CodDigita, NumRemi, TipoDocum, NumDocum, CodAdmin, TipUsuario, Apellido1, Apellido2, Nombre1, Nombre2, Edad, EdadMedi, Sexo, CodDpto, CodMuni, ZonaResi, Exportado, CodDptoCity " +
                       ...
                       "([Datos temporal usuarios RIPS].[NumRemi] = N'" + Coenti02 + "')";
                        ...
                        if (TabUsuaTemp.HasRows == false)
                        {
                            ...
                            Utils.Informa = Utils.Informa + "tempral de usuarios no hay registros para ";
                        ...
                        else
                        {
                            ...
                            if (TolUsa > RegExp)
                            {
                                ...
                                Utils.Informa = Utils.Informa + "a exportar, solo se copiaron " + RegExp;
                        ...
                        if (Siga == 1)
                        {
                            if (TolHos > 0)
                            {
                                ...
                                Mj = Mj + "Cantidad de hospitalizaciones: " + VR;
                            ...
                            if (TolObs > 0)
                            {
                                ...
                                Mj = Mj + "Cantidad usuarios en observación: " + VR;
                            ...
                            if (TolReN > 0)
                            {
                                ...
                                Mj = Mj + "Cantidad de recien nacidos: " + VR;
                            ...
                            if (TolConsul > 0)
                            {
                                ...
                                Mj = Mj + "Cantidad de consultas: " + VR;
                            ...
                            if (TolMedi > 0)
                            {
                                ...
                                Mj = Mj + "Cantidad de medicamentos: " + VR;
                            ...
                            if (TolProce > 0)
                            {
                                ...
                                Mj = Mj + "Cantidad de procedimientos: " + VR;
                            ...
                            if (TolOtros > 0)
                            {
                                ...
                                Mj = Mj + "Cantidad de otros servicios: " + VR;
                    ...
                    while (TabFacSele.Read())
                    {
                        ...
                        else
                        {
                            ...
                            Sqlsuarios = "SELECT [Datos temporal usuarios RIPS].* " +
                                        ...
                                        "ORDER BY [Datos temporal usuarios RIPS].NumRemi, " +
                                        "[Datos temporal usuarios RIPS].TipoDocum, [Datos temporal usuarios RIPS].NumDocum;";
                            ...
                            while (TabConsumos2.Read())
                            {
                                ...
                                switch (GBus2)
                                {
                                    case 1: //Consultas
                                        ...
                                        DxEntra = (TabConsumos2["DxEntra"].ToString() == "0000" ? "" : TabConsumos2["DxEntra"].ToString()); //hasta aqui llego
